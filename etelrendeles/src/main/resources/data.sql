...
//pizzak   
INSERT INTO ITEMS (NAME, DESCRIPTION, IS_SPICY, IS_VEGETARIAN, PRICE, CATEGORY_ID) VALUES ('Al Capone','ham, egg, clam, fish, cheese', 'false', 'false','1650' ,1); //1
...
INSERT INTO ITEMS (NAME, DESCRIPTION, IS_SPICY, IS_VEGETARIAN, PRICE, CATEGORY_ID) VALUES ('SonGoKu', 'ham, mushroom, corn, cheese', 'false', 'false', '1550' ,1); //11

//hamburgerek
INSERT INTO ITEMS (NAME, DESCRIPTION, IS_SPICY, IS_VEGETARIAN, PRICE, CATEGORY_ID) VALUES ('Buffalo burger', 'puffs, beef, vegetables, fried onions, smoked cheese, sauce', 'false', 'false', '1150' , 2); //12
...
INSERT INTO ITEMS (NAME, DESCRIPTION, IS_SPICY, IS_VEGETARIAN, PRICE, CATEGORY_ID) VALUES ('Röszti burger', 'puffs, beef, vegetables, dupla bacon, röszti, cheese, mustard, barbecue sauce', 'false', 'false', '850' , 2);
INSERT INTO ITEMS (NAME, DESCRIPTION, IS_SPICY, IS_VEGETARIAN, PRICE, CATEGORY_ID) VALUES ('Vega burger', 'puffs, fried cheese, fried onions, salad, cabbage, cucumber, tomato, tartar sauce', 'false', 'false', '850' , 2); //18

//levesek
INSERT INTO ITEMS (NAME, DESCRIPTION, IS_SPICY, IS_VEGETARIAN, PRICE,CATEGORY_ID) VALUES ('Bean soup', 'bowl', 'false', 'false', ,'850' , 3); //19
...
INSERT INTO ITEMS (NAME, DESCRIPTION, IS_SPICY, IS_VEGETARIAN, PRICE,CATEGORY_ID) VALUES ('Pickled turkey soup', 'bowl', 'false', 'false', ,'850' , 3); //23


//salaták
INSERT INTO ITEMS (NAME, DESCRIPTION, IS_SPICY, IS_VEGETARIAN, PRICE,CATEGORY_ID) VALUES ('Caesar', 'grilled chicken breast, ice lettuce, tomato, pepper, cucumber, crouton, ceasar dressing', 'false', 'false', ,'2000' , 4); //24
...
INSERT INTO ITEMS (NAME, DESCRIPTION, IS_SPICY, IS_VEGETARIAN, PRICE,CATEGORY_ID) VALUES ('Tzatziki salad', 'kefir, sour cream, cottage cheese, cucumber, garlic, crouton', 'false', 'true', ,'1400' , 4); //31

//italok
INSERT INTO ITEMS (NAME, DESCRIPTION, IS_SPICY, IS_VEGETARIAN, PRICE,CATEGORY_ID) VALUES ('Water', ' 0,5l', 'false', 'false', ,'50' , 5); //32
...
INSERT INTO ITEMS (NAME, DESCRIPTION, IS_SPICY, IS_VEGETARIAN, PRICE,CATEGORY_ID) VALUES ('Jagermeister',' 0,3l', 'false', 'false', ,'5' , 5);
...
INSERT INTO ITEMS (NAME, DESCRIPTION, IS_SPICY, IS_VEGETARIAN, PRICE,CATEGORY_ID) VALUES ('Kenley',' 0,33l', 'false', 'false', ,'400' , 5); //49
...
INSERT INTO ORDERS (NAME, ADDRESS, PHONE, RECEIVED,STATUS,USER_ID) VALUES ('Hudini', 'Water str 12.', '06206666666',current_timestamp,'IDLE',4);
...
INSERT INTO ORDERS (NAME, ADDRESS, PHONE, RECEIVED,DELIVERED,STATUS,USER_ID) VALUES ('Jarvas', 'Fire str 21.', '06305555555',current_timestamp,current_timestamp,'DELIVERED',8);
...
INSERT INTO ORDER_ITEMS (ORDER_ID, ITEM_ID) VALUES (1,49);
